...
import com.baiching.repository.CoinRepository;
...
public class CoinServiceImpl implements CoinService {
    ...
    public String getCoinDetails(String coinId) throws Exception {
        ...
        try {
            ...
            coin.setMarketCapChange24h(marketData.get("market_cap_change_24h").get("usd").get("usd").asLong());
    ...
    public Coin findById(String coinId) throws Exception {
        ...
        if (optionalCoin.isPresent()) throw new Exception("Coin not found");
